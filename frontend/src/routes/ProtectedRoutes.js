...
const PatientChatListPage = lazy(() => import("../pages/Patient/PatientChatListPage"));
  ...
  return (
      <Suspense fallback={<div className="p-10 text-center">Loading...</div>}>
        <Routes>
          ...
          <Route path="/patient/chats" element={<PatientChatListPage />} />
          ...
          <Route element={<PrivateRoute allowedRoles={[Roles.USER]} />}>
            ...
            <Route path="/patient/chats" element={<PatientChatListPage />} /> {/* Duplicate route for clarity */}
          </Route>
        </Routes>
      </Suspense>
  );
